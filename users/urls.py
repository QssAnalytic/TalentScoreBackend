...
urlpatterns = [
    ...
    path('get-summry-prompt/<str:email>/', cv_views.SummryPromptAPIView.as_view(),name='get-summry-prompt'),
    path('get-experiance-prompt/<str:email>/', cv_views.ExperiancePromptAPIView.as_view(),name='get-experiance-prompt'),
    path('get-cv-content-prompt/<str:email>/', cv_views.CvContentPromptAPIView.as_view(),name='get-cv-content-prompt'),
    path('get-job-title-prompt/<str:email>/', cv_views.JobTitleAPIView.as_view(),name='get-job-title-prompt'),
